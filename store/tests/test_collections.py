...
def retrieve_collection(api_client):
    def do_retrieve_collection(collection):
        return api_client.get(f'/store/collections/{collection}/')
...
class TestRetrieveCollection:
    def test_if_valid_collection_returns_200(self, retrieve_collection):
